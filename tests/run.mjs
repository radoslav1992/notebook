...
try {
  await waitForMock();
  for (const file of ['logic.test.mjs', 'access.test.mjs', 'ai.test.mjs', 'jobs.test.mjs', 'email.test.mjs', 'auth.test.mjs', 'limits.test.mjs', 'search.test.mjs', 'isolation.test.mjs', 'docx.test.mjs', 'pdf.test.mjs', 'rag.test.mjs']) {
    console.log(`\n──────── ${file} ────────`);

...
interface ZapiskiEnv {
  ...
  /**
   * Кой има достъп до админ панела — имейли, разделени със запетая.
   *
   * Променлива, а не колона в базата: това е роля на платформата, не на
   * потребител. Няма схема за мигриране, няма как да се сложи с UPDATE, и се маха,
   * без да се пипа базата.
   */
  ADMIN_EMAILS?: string;
  EMBED_MODEL?: string;
  TTS_MODEL?: string;

 ...
 *
 * Затова тук стои само това, което страницата с цените показва. Плащането е по
 * фактура, извън приложението; админът записва договорените места на
 * организацията (виж `setOrgSeats`), а от тях се смята общият пакет въпроси.
 */

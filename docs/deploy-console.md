...
| 3 | „Направи профил“ | Влиза в `/app`; без настроен доставчик връзката за потвърждаване се показва на екрана |
...
| **Имейли** | истински писма за потвърждаване, нова парола и формата за контакт | [email.md](email.md) |
